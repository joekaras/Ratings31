{*************************************************************************
*
*      DBISAM Master/Detail Field Links Editor
*      dialog for Kylix 2.x +
*
*      Copied from Delphi 6 for use under Kylix 2 and 3
...
uses
  SysUtils, Classes, QForms, QControls, QStdCtrls, QExtCtrls,
  QButtons, DB, DesignIntf, DesignEditors;
