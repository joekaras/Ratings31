unit UnitProcessEquibaseCharts;
...
procedure ProcessEquibaseCharts(tblR: TDBISAMTable; tblH: TDBISAMTable; tblE: TDBISAMTable; Sender: TObject; bUseOverride: boolean);
      ...
      try
         ...
         while not tblE.Eof do begin
            ...
            try
               ...
               if (dm.tblEquibaseCharts.BlobSize = 0) then begin
                  tblE.Next();
                  continue;
               end;

               if (dm.tblEquibaseCharts.BlobSize < MIN_EQUIBASE_FILE_SIZE) then begin
                  tblE.Delete();
                  continue;
               end;
