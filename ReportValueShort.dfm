object ValueShortReportForm: TValueShortReportForm
  Left = 117
  Top = 271
  Width = 708
  Height = 317
  Caption = 'Short Value Sheet Report'
  Color = clBtnFace
  ...
  object dbShortValueReport: TDBISAMDatabase
    EngineVersion = '4.24 Build 1'
    DatabaseName = 'dbShortValueReport'
  ...
  object tblEntries: TDBISAMTable
    ...
    CopyOnAppend = False
    Filter = 
      '((((IsValueWagerSelected=True) and (MorningLineTo1Rank>1)) or((I' +
      'sSpeedSheetSelected=True) and (MorningLineTo1Rank>1))) and (IsPr' +
      'intedOnValueSheet = True)) or (IsTrainerSheetSelected = True)'
    Filtered = True
    DatabaseName = 'dbShortValueReport'
    EngineVersion = '4.24 Build 1'
  ...
  object ppShortValueReport: TppReport
    AutoStop = False
