...
begin
   ...
   try
      try
         ...
         for iIdx := 0 to lstPCS.Count - 1 do begin
...
//               end;
               ...
               if (Trim(sppraceDate[1]) <> '') then begin
                  ...
                  sLDistanceDesc := tblE.FieldByName('LastDistanceDesc').AsString;
                  ...
                  sLRaceConditions := LeftStr(tblE.FieldByName('LastRaceConditions').AsString, 15);
               ...
               if (Trim(sppraceDate[2]) <> '') then begin
                  ...
                  sLDistanceDesc := tblE.FieldByName('Last2DistanceDesc').AsString;
                  ...
                  sLRaceConditions := LeftStr(tblE.FieldByName('Last2RaceConditions').AsString, 15);
               ...
               if (Trim(sppraceDate[3]) <> '') then begin
                  ...
                  sLDistanceDesc := tblE.FieldByName('Last3DistanceDesc').AsString;
                  ...
                  sLRaceConditions := LeftStr(tblE.FieldByName('Last3RaceConditions').AsString, 15);
